...
export interface RA_ChoreographyExampleInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "enact"
      | "items"
...
export interface RA_ChoreographyExample extends BaseContract {
  connect(runner?: ContractRunner | null): RA_ChoreographyExample;
  waitForDeployment(): Promise<this>;

  interface: RA_ChoreographyExampleInterface;
