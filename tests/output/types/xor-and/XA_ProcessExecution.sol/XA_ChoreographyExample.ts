...
export interface XA_ChoreographyExampleInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "enact"
      | "items"
...
export interface XA_ChoreographyExample extends BaseContract {
  connect(runner?: ContractRunner | null): XA_ChoreographyExample;
  waitForDeployment(): Promise<this>;

  interface: XA_ChoreographyExampleInterface;
