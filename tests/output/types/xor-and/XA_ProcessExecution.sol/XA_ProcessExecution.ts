...
export interface XA_ProcessExecutionInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "enact"
      | "items"
...
export interface XA_ProcessExecution extends BaseContract {
  connect(runner?: ContractRunner | null): XA_ProcessExecution;
  waitForDeployment(): Promise<this>;

  interface: XA_ProcessExecutionInterface;
