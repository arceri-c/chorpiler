...
export interface OnlineOrderInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "enact"
      | "items"
...
export interface OnlineOrder extends BaseContract {
  connect(runner?: ContractRunner | null): OnlineOrder;
